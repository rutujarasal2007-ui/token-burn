// Orchestrator for `npm run setup`: brings up the local devnet services the
// network needs, compiles the contract, and deploys it. Forwards --network.
...
async function main(): Promise<void> {
  ...
  process.stdout.write(`\n→ Setting up Token Burn on network: ${network}\n\n`);
